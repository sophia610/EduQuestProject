...
namespace Models
{
    public class Result
    {
        ...
        public Result(int result_id, int student_id, int question_id, int quiz_id, int is_correct,
                      int used_hint, int time_taken, int rating, int score, DateTime answered_at)
        {
